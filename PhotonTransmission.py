...
class PhotonTransmission:
    ...
    def calc_second_subspace(self):
        ...
        # # print(norm)
        tol = 10e-5
        # lambda2.real[abs(lambda2.real) < tol] = 0.0
        # lambda2.imag[abs(lambda2.imag) < tol] = 0.0
        # phi2.real[abs(phi2.real) < tol] = 0.0
        # phi2.imag[abs(phi2.imag) < tol] = 0.0
        # a = self.phi2@np.diag(self.lambda2)@self.phi2v
        # a.real[abs(a.real) < tol] = 0.0
        # a.imag[abs(a.imag) < tol] = 0.0
        # print(a)
        # print()
